                ...
                {filteredCategories.map((category) => (
                    <div key={category.id} className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                        <div className="flex items-center justify-between">
                            ...
                            <span className={`px-2 py-1 text-xs font-semibold rounded-full ${!category.deletedAt ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                                }`}>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {filteredCategories.map((category) => (
                            <tr key={category.id} className="hover:bg-gray-50 transition-colors">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${!category.deletedAt ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                                        }`}>
                                        {!category.deletedAt ? 'Active' : 'Inactive'}
                                    </span>
                                </td>
